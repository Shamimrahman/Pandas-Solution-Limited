              ...
              >
                ...
                <div class="flex justify-between items-center mt-6 pt-6">
                  <div class="flex items-center">
                    <img
                      src="http://cdn.shopify.com/s/files/1/0047/9730/0847/collections/nurserylive-flowering-plants-category-image.jpg?v=1619700115"
                      width="60"
                      class="rounded-full "
                    />
                ...
                <div class="flex justify-between items-center pt-6 mt-6 border-t">
                  <div class="flex items-center">
                    <img
                      src="https://i.ndtvimg.com/i/2018-02/rose-day_270x300_51517924628.jpg"
                      width="60"
                      class="rounded-full "
                    />
                    ...
                    <div class="flex flex-col ml-3 ">
                      {" "}
                      <span class="text-md font-medium w-auto">Rose</span>{" "}
                      <span class="text-xs font-light text-gray-400">
                        #66999
                      </span>{" "}
                    </div>
                ...
                <div class="flex justify-between items-center mt-6 pt-6 border-t">
                  <div class="flex items-center">
                    <img
                      src="https://live.staticflickr.com/207/452222788_130055c581_n.jpg"
                      width="60"
                      class="rounded-full "
                    />
                    <div class="flex flex-col ml-3 ">
                      {" "}
                      <span class="text-md font-medium">Camelia</span>{" "}
                      <span class="text-xs font-light text-gray-400">
                        #86577
                      </span>{" "}
                    </div>
