        ...
        <div class="flex shadow-md my-10">
          <div class="w-3/4  bg-white px-10 py-10">
            ...
            <div class="flex mt-10 mb-5">
              ...
              <h3 class="font-semibold r text-gray-600 text-xs uppercase w-1/5 text-center">
                Total
              </h3>
            </div>
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div class="flex w-2/5">
                <div class="w-20">
                  <img
                    class="h-24"
                    src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-12-pro-blue-hero?wid=940&hei=1112&fmt=png-alpha&.v=1604021661000"
                    alt=""
                  />
                </div>
                <div class="flex flex-col justify-between ml-4 flex-grow">
                  <span class="font-bold text-sm">Iphone 12Pro Max</span>
          ...
          <div id="summary" class="w-1/4 px-8 py-10">
            ...
            <div class="border-t mt-8">
              ...
              <button class="bg-gray-900 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">
                Checkout
              </button>
            </div>
          </div>
