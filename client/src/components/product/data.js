const data = [
...

  {
    ...
    price: " $1715 / 1,45,000৳ -",
    description:
      " Smart Hospital is Modern and Complete Hospital Automation Software that suites to almost every hospital or medical institution from patient OPD visits to Operation to Pathology Test etc. ",
  },
